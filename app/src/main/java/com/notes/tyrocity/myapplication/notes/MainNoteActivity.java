...
public class MainNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setBackgroundColor(ContextCompat.getColor(MainNoteActivity.this, R.color.colorPrimary));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Log.d(TAG, "onOptionsItemSelected: "+ notesList.get(1).getCreatedTime().);
        ...
        switch (item.getItemId()){
            ...
            case R.id.show_pending:
                ...
                //Log.d(TAG, "onOptionsItemSelected: " + note.getPriority() );
